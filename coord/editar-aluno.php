...
$aluno = new Aluno();
$aluno = $controleAluno->buscarAluno($idAluno);
$idEscola = $_GET['idEscola'];
$turmas = $controleTurmas->buscarTurmasEscola($idEscola);
            ...
            <div id="page-wrapper">
                ...
                <!--BEGIN CONTENT-->
                                ...
                                <div id="tab-edit" class="tab-pane fade active in">
                                        ...
                                        <form action="../Controller/ControladorAluno.php" method="post" class="form-horizontal"><h3>Editar Aluno</h3>

                                            <div class="form-group"><label class="col-sm-3 control-label">Nome</label>

                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><input name="nome" value='<?php echo $aluno->nome_aluno?>' class="form-control"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group"><label class="col-sm-3 control-label">Turma</label>

                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9">
                                                        <!-- <input placeholder="Turma" class="form-control" type="text"> -->
                                                        <select name="idTurmaNova">
                                                            <?php 
                                                                foreach ($turmas as $turma) {
                                                                  ...
                                                                  if($turma->idTurma != $aluno->idTurma){
                                                                    ...
                                                                    echo "<option selected='selected' value=".$turma->idTurma.">".$turma->nome."</option>";
                                                                  }
                                                             ?>
