            ...
            <div id="page-wrapper">
                ...
                <div class="page-content">
                        ...
                        <div class="row mbl">
                            ...
                            <h1>Escola <?php echo $escola->nome; ?> - Turmas</h1>
                            <div class="col-lg-12">
                                <div class="row">
                                 <div class="col-lg-6">                                    
                                ...
                                <button onclick="window.location.href='cadastro-turma.php?idEscola=<?php echo $idEscola;?>'" type="button" class="btn btn-danger">Adicionar Turma</button>
                            </div>
                            
                        </div>
                    
<button onclick="window.location.href='avaliar-alunos.php?idEscola=<?php echo $idEscola;?>'" type="button" class="btn btn-primary">Avaliar Alunos da Escola</button>
