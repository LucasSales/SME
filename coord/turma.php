            ...
            <div id="page-wrapper">
                ...
                <div class="page-content">
                        ...
                        <div class="row mbl">
                            ...
                            <h1>Turma <?php echo $turma->nome; ?> - Alunos</h1>
                            <div class="col-lg-12">
                                <div class="row">
                                 <div class="col-lg-6">                                    
                                ...
                                <button onclick="window.location.href='cadastro-aluno.php?idTurma=<?php echo $idTurma;?> & idEscola=<?php echo $idEscola;?>'" type="button" class="btn btn-primary">Adicionar Aluno</button>
                            </div>
