            ...
            <div id="page-wrapper">
                ...
                <!--BEGIN CONTENT-->
                                ...
                                <div id="tab-edit" class="tab-pane fade active in">
                                        ...
                                        <form action="#" class="form-horizontal"><h3>Cadastro Escola</h3>

                                            <div class="form-group"><label class="col-sm-3 control-label">Nome</label>

                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><input placeholder="email@yourcompany.com" class="form-control" type="email"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-3 control-label">Endereço</label>

                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><input placeholder="username" class="form-control" type="text"></div>
                                                    </div>
                                                </div>
                                            </div>
