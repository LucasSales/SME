            ...
            <div id="page-wrapper">
                ...
                <!--BEGIN CONTENT-->
                                ...
                                <div id="tab-edit" class="tab-pane fade active in">
                                        ...
                                        <form action="../Controller/ControladorUsuario.php" method="post" class="form-horizontal"><h3>Cadastrar Coordenador da Regional <?php echo $regional->nome;?></h3>

                                            <div class="form-group"><label class="col-sm-3 control-label">Email</label>

                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><input placeholder="nomeregional@sare.com" name="email" class="form-control" type="text"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group"><label class="col-sm-3 control-label">Senha</label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><input name="senha" id="senh"a class="form-control" type="password"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-3 control-label">Confirmar Senha</label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><input name="confirmar" id="confirmar" class="form-control" type="password"></div>
                                                    </div>
                                                </div>
                                            </div>
