                ...
                <div class="page-content">
                    ...
                    <div class="col-lg-12">
                        <div class="list-group">
                          ...
                          <?php 
                            foreach ($lista_regionais as $regional) {
                          ?>
                          
                          <a href="regional.php?id_regional=<?php echo $regional->idRegional;?> & opcao=admin" class="list-group-item"><?php echo $regional->nome; ?></a>
