        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li class="active"><a href="cadastro-regional.php"><i class="glyphicon glyphicon-plus-sign">
            ...
            <div id="page-wrapper">
                ...
                <!--BEGIN CONTENT-->
                                ...
                                <div id="tab-edit" class="tab-pane fade active in">
                                        ...
                                        <form action="../Controller/ControladorRegional.php" method="post" class="form-horizontal"><h3>Cadastro Regional</h3>
